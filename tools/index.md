...
- Tool/methodology notes live under `tools/<tool>/<use-case>/` (to support many related notes per tool and per use-case).
- Any time a new note is added, **update this index** with:
  - Title (as a link)
  - Date (ISO `YYYY-MM-DD`)
  - Tool (which tool this note is related to)
  - Use case (which tool use-case / context this note applies to)
  - 1–2 line summary
  - Optional tags
