...
- 2026-01-18 — [CDRP Bootstrap Project Anchor (Context-Transfer Router)](./cfc-drift-recalibration-protocol/methodology/2026-01-18--cdrp-bootstrap-project-anchor.md) — Tool: CFC Drift Recalibration Protocol (CDRP) — Category: Methodology — Bootstrap-phase anchor for staging a dedicated CDRP agent: captures rationale, constraints, and planned context-transfer artifacts (no tool methodology/use-case artifacts yet). (Tags: bootstrap; project-anchor; context-transfer; drift; external-ai)
- 2026-01-13 — [Stage 3 Response Example — Value, Impact, and Confidence Calibration](./epistemic-contract-engineering/use-cases/high-stakes-ai-collaboration/2026-01-13--stage-3-response-example-value-impact-and-confidence-calibration.md) — Tool: Epistemic Contract Engineering / Two-Stage Epistemic Binding Protocol — Use case: High-Stakes AI Collaboration — Stage 3 response example calibrating value, impact, and confidence under extreme pressure. (Tags: stage-3; response; example; calibration)
- 2026-01-13 — [Stage 3 Prompt — Value, Impact, and Confidence Calibration (High-Stakes Context)](./epistemic-contract-engineering/use-cases/high-stakes-ai-collaboration/2026-01-13--stage-3-prompt-instance-value-impact-and-confidence-calibration.md) — Tool: Epistemic Contract Engineering / Two-Stage Epistemic Binding Protocol — Use case: High-Stakes AI Collaboration — Stage 3 prompt for value, impact, and confidence calibration under extreme pressure. (Tags: stage-3; prompt; calibration)
- 2026-01-13 — [Stage 3 — Value, Impact, and Confidence Calibration (Methodology)](./epistemic-contract-engineering/methodology/2026-01-13--stage-3-value-impact-and-confidence-calibration-methodology.md) — Tool: Epistemic Contract Engineering / Two-Stage Epistemic Binding Protocol — Category: Methodology — Stage 3 protocol for value, impact, and confidence calibration under high-stakes uncertainty (ranges + anchors + error-asymmetry) to prevent abandonment via underestimation without introducing delusional certainty. (Tags: stage-3; calibration; error-asymmetry; decision support)
